...
EOF
    ...
    # === 3. Wallpapers for Multiple DEs/WMs ===
    ...
    # Merged environment.etc definitions for ASCII art and DE-specific wallpaper symlinks/scripts
...
DeMoD LLC
    ...
    # Fallback for WMs: Copy to ~/Pictures/Wallpapers for all users
